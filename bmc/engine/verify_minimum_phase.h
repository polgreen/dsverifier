...
int verify_minimum_phase(void){
	...
	/* check the realization */
		...
		fxp_to_float_array(_b, b_fxp, ds.b_size);
		...
		fxp_float_to_fxp_array(b_cascade, b_cascade_fxp, b_cascade_size);
		float b_cascade_qtz[100];
		/* get quantized values for denominator */
		fxp_to_float_array(b_cascade_qtz, b_cascade_fxp, b_cascade_size);
		int i=0;
